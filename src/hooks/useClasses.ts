...
export function useClasses() {
  ...
  const createClass = async (classData: Omit<Class, 'id' | 'professor_id' | 'join_code'>) => {
    if (!user) throw new Error('Not authenticated');

    // join_code is auto-generated by database trigger
    const { data, error: createError } = await supabase
      ...
      .insert({
        ...
        proximity_radius_meters: classData.proximity_radius_meters,
